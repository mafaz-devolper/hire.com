                  ...
                  <CardContent className="space-y-6">
                    <div className="space-y-4">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Add skills that are relevant to your profession. These will help employers understand your
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div
                    className={`border rounded-md p-2 cursor-pointer ${
                      resumeData.template === "modern" ? "border-primary bg-primary/5" : ""
                    }`}
                  ...
                  <div
                    className={`border rounded-md p-2 cursor-pointer ${
                      resumeData.template === "classic" ? "border-primary bg-primary/5" : ""
                    }`}
                  ...
                  <div
                    className={`border rounded-md p-2 cursor-pointer ${
                      resumeData.template === "creative" ? "border-primary bg-primary/5" : ""
                    }`}
                  ...
                  <div
                    className={`border rounded-md p-2 cursor-pointer ${
                      resumeData.template === "minimal" ? "border-primary bg-primary/5" : ""
                    }`}
